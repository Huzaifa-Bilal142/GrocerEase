   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         if($update_image){
            ...
            if (file_exists('uploaded_img/' . $old_image) && is_file('uploaded_img/' . $old_image)) {
...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="Dairy_Items">Dairy & Eggs</option>
               <option value="Vegetables">Vegetables</option>
               <option value="Fruits">Fruits</option>
               <option value="Meat_Seafood">Meat & Seafood</option>
               <option value="Bakery">Bakery</option>
               <option value="Pantry Staples">Pantry Staples</option>
               <option value="Snacks_Beverages">Snacks & Beverages</option>
